...
class OwnerControllerTests {
	...
	private static final String ADDRESS_110_W_LIBERTY = "110 W. Liberty St.";

	private static final String MADISON = "Madison";

	private static final String TELEPHONE_6085551023 = "6085551023";
	...
	private Owner george() {
		...
		george.setAddress(ADDRESS_110_W_LIBERTY);
		george.setCity(MADISON);
		george.setTelephone(TELEPHONE_6085551023);
		Pet max = new Pet();
	...
	void testInitUpdateOwnerForm() throws Exception {
		mockMvc.perform(get(OWNERS_OWNER_ID_EDIT, TEST_OWNER_ID))
			.andExpect(status().isOk())
			.andExpect(model().attributeExists(OWNER))
			...
			.andExpect(model().attribute(OWNER, hasProperty(ADDRESS, is(ADDRESS_110_W_LIBERTY))))
	...
	void testProcessUpdateOwnerFormUnchangedSuccess() throws Exception {
		mockMvc.perform(post(OWNERS_OWNER_ID_EDIT, TEST_OWNER_ID))
			.andExpect(status().is3xxRedirection())
			.andExpect(view().name("redirect:/owners/{ownerId}"));
	}
	...
	public void testProcessUpdateOwnerFormWithIdMismatch() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post(OWNERS_OWNER_ID_EDIT, pathOwnerId).flashAttr(OWNER, owner))
			.andExpect(status().is3xxRedirection())
